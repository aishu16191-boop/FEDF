...
export const addFaculty = async () => {
    ...
    const newObj = { id: getId(), name, empid, dept, desig, photo };
...
.id-card { width: 320px; height: 500px; border: 2px solid black; border-radius: 10px; padding: 10px; }
.header { display: flex; justify-content: center; align-items: center; gap: 10px; }
.logo { width: 40px; height: 40px; }
.title { color: red; font-weight: bold; }
.photo-box { width: 105px; height: 135px; margin: 10px auto; overflow: hidden; border: 2px solid black; }
...
<div class="id-card">
<div class="header">
<img src="KLlogo.png" width="200" height="50"><br>
</div>
<p>Faculty ID Card</p>
<div class="photo-box">
<img src="${f.photo}">
...
<p>${f.dept}</p>
<div class="footer">
Bowrampet, Hyderabad, Telangana - 500043<br> Ph: 040-23542127
</div>
</div>
</body>
</html>
